...
public class Jump : MonoBehaviour
{
    ...
    // coyote time: the time after the player has left the ground that they can still jump
    // jump buffer: the time after the player has pressed the jump button that they can still jump
