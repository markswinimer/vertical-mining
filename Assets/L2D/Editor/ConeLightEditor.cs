...
namespace L2D
{
    [CustomEditor(typeof(ConeLight))]
    public class ConeLightEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ConeLight script = (ConeLight)target;
            ...
            using (new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                bool newfollowMouse = EditorGUILayout.Toggle(new GUIContent("Follow Mouse", "If true this light will always point towards the mouse cursor."), script.followMouse);
                ...
                float newaimDirection = EditorGUILayout.FloatField(new GUIContent("Aim Direction", "What direction the cone is facing in degrees."), script.aimDirection);
